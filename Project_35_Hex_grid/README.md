...
## Usage
1. Open the hexgrid.py file in a text editor.

2. Modify the constants X_REPEAT and Y_REPEAT to adjust the number of hexagons horizontally and vertically.

3. To run the program and display the hexagonal grid on the screen, use the following command:
